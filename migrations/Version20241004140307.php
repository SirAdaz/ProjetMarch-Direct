 ...
 */
final class Version20241004140307 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, produits_commande JSON NOT NULL, date DATETIME NOT NULL, etat VARCHAR(255) NOT NULL, hour_recup VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE historique (id INT AUTO_INCREMENT NOT NULL, user_histo_id INT DEFAULT NULL, date DATETIME NOT NULL, INDEX IDX_EDBFD5ECE32E4B46 (user_histo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE marche (id INT AUTO_INCREMENT NOT NULL, marche_name VARCHAR(255) NOT NULL, place VARCHAR(255) NOT NULL, image_file_name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, user_product_id INT DEFAULT NULL, preoduct_name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, prix DOUBLE PRECISION NOT NULL, stock INT NOT NULL, disponibility TINYINT(1) NOT NULL, image_file_name VARCHAR(255) NOT NULL, INDEX IDX_29A5EC27E2E3A0B6 (user_product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, user_name VARCHAR(255) NOT NULL, tel VARCHAR(255) NOT NULL, name_business VARCHAR(255) DEFAULT NULL, stats JSON DEFAULT NULL, image_file_name VARCHAR(255) NOT NULL, description_commerce LONGTEXT DEFAULT NULL, place_marche VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE historique ADD CONSTRAINT FK_EDBFD5ECE32E4B46 FOREIGN KEY (user_histo_id) REFERENCES `user` (id)');
        ...
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC27E2E3A0B6 FOREIGN KEY (user_product_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE historique DROP FOREIGN KEY FK_EDBFD5ECE32E4B46');
        ...
        $this->addSql('ALTER TABLE produit DROP FOREIGN KEY FK_29A5EC27E2E3A0B6');
